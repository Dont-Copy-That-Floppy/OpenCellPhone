...
/*!
  ...
  @license  BSD license, all text above and below must be included in
            any redistribution
     I have modified this library to include the textRotate function with 
  boolean input, and a swap for vertical and horizontal scan vectors
...
/**************************************************************************/
/*!
  Sets the text to a 90 degree angle
*/
/**************************************************************************/
